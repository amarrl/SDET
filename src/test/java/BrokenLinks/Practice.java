...
public class Practice {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(
				By.xpath("//p[text()='Sign in with Google']/parent::span/parent::button/parent::div")));
		WebElement sigin = driver
				.findElement(By.xpath("//p[text()='Sign in with Google']/parent::span/parent::button/parent::div"));
		...
		for (String windowids : ids) {
			...
			if (driver.getCurrentUrl().contains("https://accounts.google.com/")
					|| driver.getCurrentUrl().contains("https://accounts.google.com/")) {
				driver.manage().window().maximize();
				...
				try {
					// wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//div[contains(text(),'Google
					// sent a notification to y')]/ancestor::div/descendant::img")));
					WebElement galaxy = driver.findElement(By.xpath(
							"//div[contains(text(),'Google sent a notification to y')]/ancestor::div/descendant::img"));
				...
				WebElement getVerificationcode = driver
		...
		for (String windowid2 : ids2) {
			...
			if (saarathiHomePage.equals("Saarathi")) {
				WebElement WelcomePage = driver.findElement(
						By.xpath("//span[text()='My Leads']/preceding::p[contains(text(),'Welcome, cf testnaut')]"));
		...
		WebElement phonenumber = driver
				.findElement(By.xpath("//span[text()='Phone Number']/..//input[@placeholder='9999999998']"));
		...
		WebElement d2c = driver
				.findElement(By.xpath("//span[text()='Channel']/parent::div/descendant::label[@for='D2C']"));
		...
		WebElement digitCode4 = driver.findElement(By.xpath(
				"//p[contains(text(),'Enter the 4-digit code ')]/parent::div/descendant::div[contains(@class,'ant-otp')]"));
